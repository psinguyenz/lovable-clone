"use client"; // because it's imported in a server component
...
export const ProjectForm = () => {
    ...
    const onSubmit = async (values: z.infer<typeof formSchema>) => {
        // when user hit submit, this get values from form then call "createProject" to push to server using tRPC
